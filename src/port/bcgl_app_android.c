...
static struct
{
    ...
    { AKEYCODE_MEDIA_PLAY_PAUSE, BC_KEY_MEDIA_PLAY_PAUSE },
    { AKEYCODE_MEDIA_STOP, BC_KEY_MEDIA_STOP },
    { AKEYCODE_MEDIA_NEXT, BC_KEY_MEDIA_NEXT },
    { AKEYCODE_MEDIA_PREVIOUS, BC_KEY_MEDIA_PREVIOUS },
    { AKEYCODE_MEDIA_REWIND, BC_KEY_MEDIA_REWIND },
    { AKEYCODE_MEDIA_FAST_FORWARD, BC_KEY_MEDIA_FAST_FORWARD },
    ...
    { AKEYCODE_MEDIA_PLAY, BC_KEY_MEDIA_PLAY },
    { AKEYCODE_MEDIA_PAUSE, BC_KEY_MEDIA_PAUSE },
    ...
    { AKEYCODE_CHANNEL_UP, BC_KEY_CHANNEL_UP },
    { AKEYCODE_CHANNEL_DOWN, BC_KEY_CHANNEL_DOWN },
